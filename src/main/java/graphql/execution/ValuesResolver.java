...
public class ValuesResolver {
  ...
  private Object coerceValue(GraphQLType graphQLType, Object value) {
    ...
    if (graphQLType instanceof GraphQLScalarType) {
      ...
      return coerceValueForInputObjectType((GraphQLInputObjectType) graphQLType,
  ...
  private Object coerceValueAst(GraphQLType type, Value inputValue, Map<String, Object> variables) {
    ...
    if (type instanceof GraphQLInputObjectType) {
      return coerceValueAstForInputObject((GraphQLInputObjectType) type, (ObjectValue) inputValue,
          variables);
    }
  ...
  private Object coerceValueAstForList(GraphQLList graphQLList, Value value,
    ...
    if (value instanceof ArrayValue) {
      ...
      return Collections
          .singletonList(coerceValueAst(graphQLList.getWrappedType(), value, variables));
    }
  }
  ...
  private Object coerceValueAstForInputObject(GraphQLInputObjectType type, ObjectValue inputValue,
    ...
    for (ObjectField objectField : inputValue.getObjectFields()) {
      ...
      Object fieldValue =
          coerceValueAst(inputObjectField.getType(), objectField.getValue(), variables);
      if (fieldValue == null) {
