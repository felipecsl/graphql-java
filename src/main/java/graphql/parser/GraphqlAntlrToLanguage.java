...
public class GraphqlAntlrToLanguage extends GraphqlBaseVisitor<Void> {
  ...
  private OperationDefinition.Operation parseOperation(
  ...
  public Void visitFragmentSpread(GraphqlParser.FragmentSpreadContext ctx) {
    ...
    ((SelectionSet) getFromContextStack(ContextProperty.SelectionSet)).getSelections()
        .add(fragmentSpread);
  ...
  public Void visitVariableDefinition(GraphqlParser.VariableDefinitionContext ctx) {
    ...
    OperationDefinition operationDefinition =
        (OperationDefinition) getFromContextStack(ContextProperty.OperationDefinition);
  ...
  private Value getValue(GraphqlParser.ValueWithVariableContext ctx) {
    if (ctx.IntValue() != null) {
      ...
      BooleanValue booleanValue =
          new BooleanValue(Boolean.parseBoolean(ctx.BooleanValue().getText()));
      ...
      for (GraphqlParser.ValueWithVariableContext valueWithVariableContext : ctx
      ...
      for (GraphqlParser.ObjectFieldWithVariableContext objectFieldWithVariableContext : ctx
          .objectValueWithVariable().objectFieldWithVariable()) {
        ObjectField objectField = new ObjectField(objectFieldWithVariableContext.NAME().getText(),
  ...
  private Value getValue(GraphqlParser.ValueContext ctx) {
    if (ctx.IntValue() != null) {
      ...
      for (GraphqlParser.ObjectFieldContext objectFieldContext : ctx.objectValue().objectField()) {
        ObjectField objectField = new ObjectField(objectFieldContext.NAME().getText(),
            getValue(objectFieldContext.value()));
        objectValue.getObjectFields().add(objectField);
      }
      return objectValue;
    }
  ...
  private SourceLocation getSourceLocation(ParserRuleContext parserRuleContext) {
    return new SourceLocation(parserRuleContext.getStart().getLine(),
