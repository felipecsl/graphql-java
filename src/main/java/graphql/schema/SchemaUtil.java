...
public class SchemaUtil {
  ...
  private void collectTypesForInterfaces(GraphQLInterfaceType interfaceType,
  ...
  private void collectTypesForInputObjects(GraphQLInputObjectType objectType,
      Map<String, GraphQLType> result) {
    if (result.containsKey(objectType.getName())) return;
    result.put(objectType.getName(), objectType);
  ...
  public List<GraphQLObjectType> findImplementations(GraphQLSchema schema,
  ...
  private void resolveTypeReferencesForFieldsContainer(GraphQLFieldsContainer fieldsContainer,
  ...
  List<GraphQLType> resolveTypeReferences(List<GraphQLType> types,
      Map<String, GraphQLType> typeMap) {
