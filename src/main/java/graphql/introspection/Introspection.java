...
public class Introspection {
  ...
  public static GraphQLEnumType __TypeKind = GraphQLEnumType.newEnum()
      ...
      .value("OBJECT", TypeKind.OBJECT,
          "Indicates this type is an object. `fields` and `interfaces` are valid fields.")
      .value("INTERFACE", TypeKind.INTERFACE,
          "Indicates this type is an interface. `fields` and `possibleTypes` are valid fields.")
      .value("UNION", TypeKind.UNION,
          "Indicates this type is a union. `possibleTypes` is a valid field.")
      .value("ENUM", TypeKind.ENUM,
          "Indicates this type is an enum. `enumValues` is a valid field.")
      .value("INPUT_OBJECT", TypeKind.INPUT_OBJECT,
  ...
  public static GraphQLObjectType __InputValue = GraphQLObjectType.newBuilder()
      .name("__InputValue")
      .field(newBuilder()
          .name("name")
  ...
  public static GraphQLObjectType __Field = GraphQLObjectType.newBuilder()
      .name("__Field")
      .field(newBuilder()
          .name("name")
          .type(new GraphQLNonNull(GraphQLString)))
  ...
  public static GraphQLObjectType __EnumValue = GraphQLObjectType.newBuilder().name("__EnumValue")
      .field(newBuilder().
          name("name")
          .type(new GraphQLNonNull(GraphQLString)))
      .field(newBuilder()
          ...
          .dataFetcher(new DataFetcher() {
            ...
            public Object get(DataFetchingEnvironment environment) {
              GraphQLEnumValueDefinition enumValue =
                  (GraphQLEnumValueDefinition) environment.getSource();
  ...
  public static DataFetcher possibleTypesFetcher = new DataFetcher() {
    ...
    public Object get(DataFetchingEnvironment environment) {
      ...
      if (type instanceof GraphQLInterfaceType) {
        return SchemaUtil
            .findImplementations(environment.getGraphQLSchema(), (GraphQLInterfaceType) type);
      }
  ...
  public static GraphQLObjectType __Type = GraphQLObjectType.newBuilder()
      .name("__Type")
      .field(newBuilder()
          .name("kind")
      ...
      .field(newBuilder()
          .name("inputFields")
          .type(new GraphQLList(new GraphQLNonNull(__InputValue))).dataFetcher(inputFieldsFetcher))
      .field(newBuilder()
          .name("ofType")
  ...
  public static GraphQLEnumType __DirectiveLocation =
      GraphQLEnumType.newEnum()
          ...
          .value("MUTATION", DirectiveLocation.MUTATION,
              "Indicates the directive is valid on mutations.")
          .value("FIELD", DirectiveLocation.FIELD, "Indicates the directive is valid on fields.")
          .value("FRAGMENT_DEFINITION", DirectiveLocation.FRAGMENT_DEFINITION,
              "Indicates the directive is valid on fragment definitions.")
          .value("FRAGMENT_SPREAD", DirectiveLocation.FRAGMENT_SPREAD,
              "Indicates the directive is valid on fragment spreads.")
          .value("INLINE_FRAGMENT", DirectiveLocation.INLINE_FRAGMENT,
              "Indicates the directive is valid on inline fragments.").build();

  public static GraphQLObjectType __Directive =
  ...
  public static GraphQLObjectType __Schema =
      GraphQLObjectType.newBuilder().name("__Schema").description(
          "A GraphQL Introspection defines the capabilities" +
  ...
  public static GraphQLFieldDefinition SchemaMetaFieldDef =
      newBuilder()
          .name("__schema")
  ...
  public static GraphQLFieldDefinition TypeMetaFieldDef =
      newBuilder().name("__type")
          .type(__Type)
  ...
  public static GraphQLFieldDefinition TypeNameMetaFieldDef =
      newBuilder()
          .name("__typename")
          .type(new GraphQLNonNull(GraphQLString))
