...
class RelaySchemaTest extends Specification {
  ...
  def "Validate Relay StuffConnection schema"() {
    ...
    fields == [[name: "edges", type: [name: "[StuffEdge]", kind: "LIST", ofType: [name: "StuffEdge", kind: "OBJECT"]]], [name: "pageInfo", type: [name: "PageInfo!", kind: "NON_NULL", ofType: [name: "PageInfo", kind: "OBJECT"]]]]
  }
