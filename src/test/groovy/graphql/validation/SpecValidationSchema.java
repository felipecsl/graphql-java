...
public class SpecValidationSchema {
  ...
  public static final GraphQLInterfaceType sentient = GraphQLInterfaceType.newInterface()
      ...
      .field(new GraphQLFieldDefinition(
          "name", null, new GraphQLNonNull(Scalars.GraphQLString), new FieldDataFetcher("name"),
          Collections.<GraphQLArgument>emptyList(), null))
  ...
  public static final GraphQLObjectType human = GraphQLObjectType.newBuilder()
      .name("Human")
      .field(new GraphQLFieldDefinition(
          "name", null, new GraphQLNonNull(Scalars.GraphQLString), new FieldDataFetcher("name"),
          Collections.<GraphQLArgument>emptyList(), null))
  ...
  public static final GraphQLObjectType alien = GraphQLObjectType.newBuilder()
      .name("Alien")
      .field(new GraphQLFieldDefinition(
          "name", null, new GraphQLNonNull(Scalars.GraphQLString), new FieldDataFetcher("name"),
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          "homePlanet", null, Scalars.GraphQLString, new FieldDataFetcher("homePlanet"),
          Collections.<GraphQLArgument>emptyList(), null))
      .withInterface(SpecValidationSchema.sentient)
      .build();
  ...
  public static final GraphQLObjectType dog = GraphQLObjectType.newBuilder()
      .name("Dog")
      .field(new GraphQLFieldDefinition(
          "name", null, new GraphQLNonNull(Scalars.GraphQLString), new FieldDataFetcher("name"),
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          "nickname", null, Scalars.GraphQLString, new FieldDataFetcher("nickname"),
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          "barkVolume", null, Scalars.GraphQLInt, new FieldDataFetcher("barkVolume"),
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          "doesKnowCommand", null, new GraphQLNonNull(Scalars.GraphQLBoolean),
          new FieldDataFetcher("doesKnowCommand"),
      ...
      .field(new GraphQLFieldDefinition(
          "owner", null, human, new FieldDataFetcher("owner"),
          Collections.<GraphQLArgument>emptyList(), null))
      .withInterface(SpecValidationSchema.pet)
      .build();

  public static final GraphQLObjectType cat = GraphQLObjectType.newBuilder()
      .name("Cat")
      .field(new GraphQLFieldDefinition(
          "name", null, new GraphQLNonNull(Scalars.GraphQLString), new FieldDataFetcher("name"),
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          ...
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          "meowVolume", null, Scalars.GraphQLInt, new FieldDataFetcher("meowVolume"),
          Collections.<GraphQLArgument>emptyList(), null))
      .field(new GraphQLFieldDefinition(
          "doesKnowCommand", null, new GraphQLNonNull(Scalars.GraphQLBoolean),
          new FieldDataFetcher("doesKnowCommand"),
  ...
  public static final GraphQLObjectType queryRoot = GraphQLObjectType.newBuilder()
      .name("QueryRoot")
      .field(new GraphQLFieldDefinition(
          "dog", null, dog, new FieldDataFetcher("dog"), Collections.<GraphQLArgument>emptyList(),
          null))
      .build();
